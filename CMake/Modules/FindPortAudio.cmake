...
if(PORTAUDIO_INCLUDE_DIR AND PORTAUDIO_LIBRARIES)
    set(PORTAUDIO_FIND_QUIETLY FALSE)
...
list(APPEND PORTAUDIO_INCLUDE_DIR "/usr/local/include/portaudio2/")

# finally the library itself
find_library(libPortAudio NAMES portaudio
PATHS $ENV{PORTAUDIO_DIR} $ENV{PORTAUDIO_DIR}/include $ENV{PORTAUDIO_DIR}/lib)
